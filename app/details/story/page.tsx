...
const data = [
  {
    ...
    image: "sidebar",
    spanish:
      "¡Bienvenidos a nuestra historia de amor! Todo comenzó un sábado por la noche en Sidebar en Central. ¡Paul retó a Xime a un juego de billar y nos llevamos bien de inmediato! En ese momento, el programa de Netflix Narcos estaba en el apogeo de su popularidad, lo que provocó algunos chistes malos. Xime se lo tomó con calma y aceptó tener una cita al día siguiente. La cita fue en el ambiente romántico de un juego de cricket en el parque.",
  },
  {
    id: 2,
    title: "Dating life",
