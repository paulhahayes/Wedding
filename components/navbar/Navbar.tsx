...
const Navbar = () => {
  ...
  return (
    <div className="w-full fixed top-0 right-0 py-4 z-10 min-[320px]:z-20">
      <div className=" text-white px-4 md:mx-40 sm:mx-20 [320px]:mx-none lg:max-w-7x1 items-center flex md:border-b border-white sm:border-0 ">
